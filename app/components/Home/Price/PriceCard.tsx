...
const PriceCard = ({bg,days,percentage,minInvest,maxInvest}:Props) => {
  return (
    <div className={`${bg} p-6 text-center rounded-lg`}>
      ...
      <h1 className='w-4/5 mx-auto bg-orange-600 text-white text-[23px] font-bold p-2 rounded-lg mt-4'>{percentage}% </h1>
      ...
      <div className='text-center mt-8'>
        <button className='rounded px-7 py-2.5 overflow-hidden group bg-yellow-500 hover:bg-gradient-to-r
